---
url: /orange-orm-docs/formula-discriminators.md
---
...
The `@this` acts as a placeholder within the formula. When  constructs a query, it replaces `@this` with the appropriate alias for the table being queried. This replacement is crucial to avoid ambiguity, especially when dealing with joins with ambigious column names.
